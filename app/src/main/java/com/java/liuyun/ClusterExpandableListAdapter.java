...
public class ClusterExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public ClusterExpandableListAdapter(List<String> groupString, List<String> groupSize, List<List<AtlasData>> childString) {
...
// 获取显示指定分组的视图
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.news_cluster_category_layout,parent,false);
            groupViewHolder = new AtlasExpandableListAdapter.GroupViewHolder();
            groupViewHolder.title = (TextView) convertView.findViewById(R.id.cluster_category_name);
            groupViewHolder.descr = (TextView) convertView.findViewById(R.id.cluster_category_size);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView==null){
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.news_cluster_item_layout,parent,false);
            childViewHolder = new AtlasExpandableListAdapter.ChildViewHolder();
            childViewHolder.title = (TextView)convertView.findViewById(R.id.cluster_item_name);
            childViewHolder.descr = (TextView)convertView.findViewById(R.id.cluster_item_description);
